...
namespace Schelet_Server
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Repository<Jucator> r1 = new Repository<Jucator>();
            Repository<Joc> r2 = new Repository<Joc>();
            Repository<JucatorJoc> r3 = new Repository<JucatorJoc>();
            ...
            //Service.Service service = new Service.Service(repouser,r1,r2,r3);

            var server = new MyServer(repouser,r1,r2,r3);
